import 'dart:convert';
import 'package:app8/api.dart';
import 'package:app8/listcolor/color.dart';
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    leading: Image.network(
                      "${widget.serverURL}/api-demo/" +
                          futureSanpham[index].hinhanh!,
                      width: 50,
                      height: 50,
                    ),
                    title: Text(futureSanpham[index].tensanpham!, style: TextStyle(fontSize: 18, color: ColorList.darkcyan, fontWeight: FontWeight.bold),),
                    subtitle: Text(
                        '${formartPrice.format(futureSanpham[index].gia!)}', style: TextStyle(fontSize: 16, color: ColorList.grey),),
                    trailing: Expanded(
                      child: Row(
